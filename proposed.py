...
class NuclearModelTrainer:
    ...
    def plot_tsne_3d(self, features, labels):
        ...
        print(f"Optimized 3D t-SNE visualization saved to {self.config.tsne_plot_path}")
        plt.show()
    ...
    def plot_feature_importance(self, loader):
        ...
        # 设置标题和标签
        plt.title('Feature Group Importance for Fault Diagnosis', 
                 fontsize=16, fontweight='bold', pad=20)
        ...
        # 保存高分辨率图片
        plt.savefig(self.config.feature_importance_path, dpi=600, bbox_inches='tight')
        print(f"Feature importance visualization saved to {self.config.feature_importance_path}")
        plt.show()
    ...
    def plot_parameter_trends(self, loader):
        ...
        # 设置总标题
        plt.suptitle('Key Parameter Trends for Different Fault Types', 
        ...
        # 保存高分辨率图片
        plt.savefig(self.config.parameter_trends_path, dpi=600, bbox_inches='tight')
        print(f"Parameter trends visualization saved to {self.config.parameter_trends_path}")
        plt.show()
    ...
    def plot_fault_comparison(self, loader):
        ...
        # 设置标题和标签
        plt.title('Average Parameter Group Values by Fault Type', 
        ...
        # 保存高分辨率图片
        plt.savefig(self.config.fault_comparison_path, dpi=600, bbox_inches='tight')
        print(f"Fault comparison visualization saved to {self.config.fault_comparison_path}")
        plt.show()
...
def main():
    ...
    try:
        ...
        # 测试模型
        test_preds, test_labels, test_explanations, test_features = trainer.test(test_loader)
        ...
        print("\nUsing ENTIRE dataset for 3D t-SNE visualization...")
        ...
        # 使用验证集数据进行其他3D可视化
        print("\nUsing VALIDATION set for other 3D visualizations...")
